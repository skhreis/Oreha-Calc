    ...
    <div class='h-full w-full bg-bgb'>
      ...
      <div className='flex justify-center place-items-center pb-10 pt-4'>
        ...
        <li class='flex flex-cols mb-2'>
          ...
          <div class='text-sm font-medium text-white' >Compares buying 20 Superior Orehas vs. Buying Relics and crafting it yourself.</div>
        </li>
        <li class='flex flex-cols mb-2'>
          ...
          <div class='text-sm font-medium text-white' >Compares buying 20 Superior Orehas vs. Buying Fish and crafting it yourself.</div>
        </li>
        <li class='flex flex-cols mb-2'>
          ...
          <div class='text-sm font-medium text-white' >Compares buying 15 Prime Orehas vs. Buying Relics and crafting it yourself.</div>
        </li>
        <li class='flex flex-rcols mb-2'>
          ...
          <div class='text-sm font-medium text-white' >Compares buying 15 Prime Orehas vs. Buying Fish and crafting it yourself.</div>
        </li>
        <li class='flex flex-cols mb-2'>
          ...
          <div class='text-sm font-medium text-white' >Profit of selling Relics, buying fish, then crafting 20 Superior Orehas </div>
        </li>
        <li class='flex flex-cols mb-2'>
          ...
          <div class='text-sm font-medium text-white' >Profit of selling Relics, buying fish, then crafting 15 Prime Orehas </div>
